  ...
  return (
    <div className="relative w-[1440px] h-[990px] overflow-visible">
      ...
      <Image
        ...
        unoptimized
      />
      <h1 className="absolute left-[1395px] top-[429px] w-[352px] h-[703px] font-circular text-[272px] leading-[352px] font-[500] text-[#383838] tracking-[-21.76px] opacity-[0.05]" style={{ transform: 'rotate(-90deg)', transformOrigin: 'center' }}>
        faceoil
      </h1>
