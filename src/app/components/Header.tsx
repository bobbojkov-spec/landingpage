...
export default function Header() {
  return (
    <div className="relative w-[1440px] h-[990px]">
      ...
      <Image
        ...
        unoptimized
      />
      <div className="absolute left-[385px] top-[618px] w-[1051px] h-[308px] bg-[#ddc0ae] blur-[27px]"></div>
      <h1 className="absolute left-[1335px] top-[144px] w-[352px] h-[703px] font-circular text-[272px] leading-[352px] font-[500] text-[#383838] tracking-[-21.76px] opacity-[0.05]" style={{ transform: 'rotate(-90deg)', transformOrigin: 'center' }}>
        faceoil
      </h1>
      ...
      <p className="absolute left-[30px] top-[931px] w-[18px] h-[14px] font-circular text-[14px] leading-[17px] font-[500] text-[#ffffff]">
        fb
      </p>
      <p className="absolute left-[30px] top-[886px] w-[18px] h-[13px] font-circular text-[14px] leading-[17px] font-[500] text-[#ffffff]">
        pi
      </p>
      <p className="absolute left-[30px] top-[842px] w-[18px] h-[12px] font-circular text-[14px] leading-[17px] font-[500] text-[#ffffff]">
        in
      </p>
      ...
      <h2 className="absolute left-[285px] top-[649px] w-[64px] h-[20px] font-circular text-[20px] leading-[20px] font-[500] text-[#ffffff]">
        $49.99
      </h2>
      ...
      <h1 className="absolute left-[135px] top-[265px] w-[459px] h-[152px] font-productsans text-[152px] leading-[152px] font-[700] text-[#a1603b] tracking-[-12.16px]">
        dangila
      </h1>
