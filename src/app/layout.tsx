...
import { circularStd, productSans, sharpSans, montserrat } from "./fonts";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${circularStd.variable} ${productSans.variable} ${sharpSans.variable} ${montserrat.variable}`}>
